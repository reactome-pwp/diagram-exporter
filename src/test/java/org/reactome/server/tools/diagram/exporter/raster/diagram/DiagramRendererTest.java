...
public class DiagramRendererTest extends BaseTest {
    ...
    public void fromDiagramObject() {
        ...
        } catch (DiagramJsonDeserializationException | DiagramJsonNotFoundException | TranscoderException |
                 AnalysisException | IOException e) {
            e.printStackTrace();
        }
    }
